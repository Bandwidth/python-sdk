...
class TestWebRtcUtilities:
    ...
    def test_generate_transfer_bxml_document(self):
        expected = "<?xml version='1.0' encoding='utf8'?>\n<Response><Transfer><SipUri uui=\"93d6f3c0be5845960b744fa28015d8ede84bd1a4;encoding=base64,asdf;encoding=jwt\">sip:sipx.webrtc.bandwidth.com:5060</SipUri></Transfer></Response>"
