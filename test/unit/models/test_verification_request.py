...
class TestVerificationRequest(unittest.TestCase):
    ...
    def testVerificationRequest(self):
        ...
        assert isinstance(instance, VerificationRequest)
        ...
        assert isinstance(instance.phone_numbers, list)
        assert len(instance.phone_numbers) == 1
        assert instance.phone_numbers[0] == '+18005555555'
