...
from bandwidth.multifactorauth.exceptions.error_with_request_error_exception import ErrorWithRequestErrorException
from bandwidth.multifactorauth.exceptions.unauthorized_request_error_exception import UnauthorizedRequestErrorException
from bandwidth.multifactorauth.exceptions.forbidden_request_error_exception import ForbiddenRequestErrorException
...
class MFAController(BaseController):
    ...
    def create_voice_two_factor(self,
        ...
        if _response.status_code == 400:
            raise ErrorWithRequestErrorException('If there is any issue with values passed in by the user', _response)
        elif _response.status_code == 401:
            raise UnauthorizedRequestErrorException('Authentication is either incorrect or not present', _response)
        elif _response.status_code == 403:
            raise ForbiddenRequestErrorException('The user is not authorized to access this resource', _response)
        elif _response.status_code == 500:
            raise ErrorWithRequestErrorException('An internal server error occurred', _response)
    ...
    def create_verify_two_factor(self,
        ...
        if _response.status_code == 400:
            ...
            raise ErrorWithRequestErrorException('The user has made too many bad requests and is temporarily locked out', _response)
        elif _response.status_code == 500:
            raise ErrorWithRequestErrorException('An internal server error occurred', _response)
        self.validate_response(_response)
