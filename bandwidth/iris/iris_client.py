...
from bandwidth.iris.controllers.internal_controller import InternalController
from bandwidth.iris.controllers.external_controller import ExternalController
...
class IrisClient(object):
    ...
    @lazy_property
    def internal(self):
        return InternalController(self.config)

    @lazy_property
    def external(self):
        return ExternalController(self.config)
