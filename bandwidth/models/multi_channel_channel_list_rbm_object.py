...
class MultiChannelChannelListRBMObject(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": MultiChannelChannelListRBMObjectAllOfContent.from_dict(obj["content"]) if obj.get("content") is not None else None
        })
