...
class GatherCallback(BaseModel):
    ...
    digits: Optional[StrictStr] = Field(default=None, description="(optional) The digits, letters, and/or symbols entered by the user. The string is empty if a timeout occurred before any buttons were pressed.")
    ...
    terminating_digit: Optional[StrictStr] = Field(default=None, description="(optional) The digit the user pressed to end the gather. Empty string value if no terminating digit was pressed.", alias="terminatingDigit")
    ...
    __properties: ClassVar[List[str]] = ["eventType", "eventTime", "accountId", "applicationId", "from", "to", "direction", "callId", "digits", "callUrl", "enqueuedTime", "startTime", "answerTime", "parentCallId", "terminatingDigit", "transferCallerId", "transferTo", "tag"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "terminatingDigit": obj.get("terminatingDigit"),
