...
class TelephoneNumber(BaseModel):
    ...
    TelephoneNumber
    """ # noqa: E501
    telephone_number: Optional[StrictStr] = Field(default=None, description="Simple Telephone Number.", alias="telephoneNumber")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["telephoneNumber"]
