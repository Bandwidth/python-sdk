...
class CreateMessageRequestError(BaseModel):
    ...
    field_errors: Optional[List[FieldError]] = Field(default=None, alias="fieldErrors")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "description", "fieldErrors"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "fieldErrors": [FieldError.from_dict(_item) for _item in obj.get("fieldErrors")] if obj.get("fieldErrors") is not None else None
        })
