...
class StatusCallback(BaseModel):
    ...
    """ # noqa: E501
    time: datetime
    event_time: Optional[datetime] = Field(default=None, description="Represents the time at which the message was read, for `message-read` callbacks.", alias="eventTime")
    type: StatusCallbackTypeEnum
    to: StrictStr = Field(description="The destination phone number the message was sent to. For status callbacks, this the the Bandwidth user's client phone number.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "message": StatusCallbackMessage.from_dict(obj["message"]) if obj.get("message") is not None else None,
