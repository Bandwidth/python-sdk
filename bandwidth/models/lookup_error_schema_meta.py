...
class LookupErrorSchemaMeta(BaseModel):
    """
    ...
    code: Optional[StrictInt] = Field(default=None, description="Error code associated with the message")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["phoneNumbers", "message", "code"]
