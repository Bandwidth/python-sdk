...
class GetAsyncBulkLookupResponse(BaseModel):
    """
    GetAsyncBulkLookupResponse
    """ # noqa: E501
    links: Optional[List[LinkSchema]] = None
    data: Optional[GetAsyncBulkLookupResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetAsyncBulkLookupResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
