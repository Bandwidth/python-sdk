...
class MachineDetectionCompleteCallback(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # and model_fields_set contains the field
        if self.machine_detection_result is None and "machine_detection_result" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "tag": obj.get("tag"),
            "machineDetectionResult": MachineDetectionResult.from_dict(obj.get("machineDetectionResult")) if obj.get("machineDetectionResult") is not None else None
        })
