...
class CreateAsyncBulkLookupResponse(BaseModel):
    """
    CreateAsyncBulkLookupResponse
    """ # noqa: E501
    links: Optional[List[LinkSchema]] = Field(default=None, description="Links for pagination (if applicable)")
    data: Optional[CreateAsyncBulkLookupResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CreateAsyncBulkLookupResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
