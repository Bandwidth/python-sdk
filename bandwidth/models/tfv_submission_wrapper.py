...
class TfvSubmissionWrapper(BaseModel):
    """
    TfvSubmissionWrapper
    """ # noqa: E501
    submission: Optional[VerificationUpdateRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "submission": VerificationUpdateRequest.from_dict(obj["submission"]) if obj.get("submission") is not None else None
        })
