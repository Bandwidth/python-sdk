...
class RbmMessageContentText(BaseModel):
    """
    RbmMessageContentText
    """ # noqa: E501
    text: Annotated[str, Field(strict=True, max_length=3270)] = Field(description="The text associated with the message. Must be 3270 characters or less")
    ...
    __properties: ClassVar[List[str]] = ["text", "suggestions"]
