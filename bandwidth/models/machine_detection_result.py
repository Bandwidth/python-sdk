...
class MachineDetectionResult(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[StrictStr] = Field(default=None, description="Possible values are answering-machine, human, silence, timeout, or error.")
    duration: Optional[StrictStr] = Field(default=None, description="The amount of time it took to determine the result.")
