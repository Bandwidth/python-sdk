...
class MultiChannelCallbackData(BaseModel):
    """
    MultiChannelCallbackData
    """ # noqa: E501
    time: Optional[datetime] = Field(default=None, description="The time of the callback event.")
    type: Optional[MultiChannelStatusEnum] = None
    ...
    message: Optional[MultiChannelMessageCallbackData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "message": MultiChannelMessageCallbackData.from_dict(obj["message"]) if obj.get("message") is not None else None
        })
