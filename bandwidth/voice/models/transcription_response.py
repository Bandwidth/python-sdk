...
"""
import bandwidth.voice.models.transcript
...
class TranscriptionResponse(object):
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('transcripts') is not None:
            transcripts = [bandwidth.voice.models.transcript.Transcript.from_dictionary(x) for x in dictionary.get('transcripts')]
