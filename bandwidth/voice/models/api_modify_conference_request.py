...
"""
from bandwidth.voice.models.status import Status


class ApiModifyConferenceRequest(object):

    """Implementation of the 'ApiModifyConferenceRequest' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ApiModifyConferenceRequest class"""
