...
class ApiCallResponseNameChangeTest(object):

    """Implementation of the 'ApiCallResponseNameChangeTest' model.
    ...
    def __init__(self,
                 ...
                 tag=None):
        """Constructor for the ApiCallResponseNameChangeTest class"""
