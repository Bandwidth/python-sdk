...
from bandwidth.exceptions import ApiTypeError, ApiValueError, ApiException
from bandwidth.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/15.0.0b/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CallsApi()
        api_instance.create_call  # this is an instance of the class Endpoint
        api_instance.create_call()  # this invokes api_instance.create_call.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_call.callable or self.callable in this class
