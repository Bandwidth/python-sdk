...
class MFAApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.generate_messaging_code_endpoint = _Endpoint(
            settings={
                'response_type': (MessagingCodeResponse,),
                'auth': [
                    'Basic'
                ],
                'endpoint_path': '/accounts/{accountId}/code/messaging',
                'operation_id': 'generate_messaging_code',
                'http_method': 'POST',
                'servers': [
                    {
        ...
        self.generate_voice_code_endpoint = _Endpoint(
            settings={
                'response_type': (VoiceCodeResponse,),
                'auth': [
                    'Basic'
                ],
                'endpoint_path': '/accounts/{accountId}/code/voice',
                'operation_id': 'generate_voice_code',
                'http_method': 'POST',
                'servers': [
                    {
                        'url': "https://mfa.bandwidth.com/api/v1",
    ...
    def generate_messaging_code(
        ...
        **kwargs
        ...
        kwargs['code_request'] = \
            code_request
        return self.generate_messaging_code_endpoint.call_with_http_info(**kwargs)
    ...
    def generate_voice_code(
        ...
        **kwargs
        ...
        kwargs['code_request'] = \
            code_request
        return self.generate_voice_code_endpoint.call_with_http_info(**kwargs)
