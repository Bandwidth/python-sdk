...
class RecordingsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_call_transcription_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/accounts/{accountId}/calls/{callId}/recordings/{recordingId}/transcription',
        ...
        self.delete_recording_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/accounts/{accountId}/calls/{callId}/recordings/{recordingId}',
        ...
        self.delete_recording_media_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/accounts/{accountId}/calls/{callId}/recordings/{recordingId}/media',
        ...
        self.get_call_recordings_endpoint = _Endpoint(
            settings={
                'response_type': ([CallRecordingMetadata],),
                'auth': [
                    'httpBasic'
                ],
                'endpoint_path': '/api/v2/accounts/{accountId}/calls/{callId}/recordings',
                'operation_id': 'get_call_recordings',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.modify_call_recording_state_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'httpBasic'
                ],
                'endpoint_path': '/api/v2/accounts/{accountId}/calls/{callId}/recording',
                'operation_id': 'modify_call_recording_state',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'account_id': 'path',
                    'call_id': 'path',
                    'modify_call_recording_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.query_call_recordings_endpoint = _Endpoint(
            settings={
                'response_type': ([CallRecordingMetadata],),
                'auth': [
                    'httpBasic'
                ],
                'endpoint_path': '/api/v2/accounts/{accountId}/recordings',
                'operation_id': 'query_call_recordings',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.transcribe_call_recording_endpoint = _Endpoint(
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'call_id': 'path',
                    'recording_id': 'path',
                    'transcribe_recording_request': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def get_call_recordings(
        ...
        **kwargs
        ...
        >>> thread = api.get_call_recordings(account_id, call_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['call_id'] = \
            call_id
        return self.get_call_recordings_endpoint.call_with_http_info(**kwargs)
    ...
    def modify_call_recording_state(
        ...
        **kwargs
        ...
        >>> thread = api.modify_call_recording_state(account_id, call_id, modify_call_recording_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['call_id'] = \
            call_id
        kwargs['modify_call_recording_request'] = \
            modify_call_recording_request
        return self.modify_call_recording_state_endpoint.call_with_http_info(**kwargs)

    def query_call_recordings(
        self,
        account_id,
        **kwargs
    ):
        ...
        >>> thread = api.query_call_recordings(account_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['account_id'] = \
            account_id
        return self.query_call_recordings_endpoint.call_with_http_info(**kwargs)
    ...
    def transcribe_call_recording(
        ...
        **kwargs
        ...
        >>> thread = api.transcribe_call_recording(account_id, call_id, recording_id, transcribe_recording_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['recording_id'] = \
            recording_id
        kwargs['transcribe_recording_request'] = \
            transcribe_recording_request
