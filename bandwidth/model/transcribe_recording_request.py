...
class TranscribeRecordingRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TranscribeRecordingRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            callback_method (str, none_type): The HTTP method to use for the request to `callbackUrl`. GET or POST. Default value is POST.. [optional]  # noqa: E501
            ...
            callback_timeout (float, none_type): This is the timeout (in seconds) to use when delivering the webhook to `callbackUrl`. Can be any numeric value (including decimals) between 1 and 25.<br>Default: 15. [optional]  # noqa: E501
        """
