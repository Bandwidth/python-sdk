...
class Subscriptions(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'participants': ([ParticipantSubscription],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, session_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            participants ([ParticipantSubscription]): Subset of participants to subscribe to in the session. Optional.  Returns empty upon creation of a Participant. [optional]  # noqa: E501
        """
