...
class CreateCallResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, application_id, account_id, call_id, to, _from, call_url, answer_method, answer_url, disconnect_method, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            enqueued_time (datetime, none_type): Time the call was accepted into the queue. [optional]  # noqa: E501
            call_timeout (float): The timeout (in seconds) for the callee to answer the call after it starts ringing.. [optional]  # noqa: E501
            callback_timeout (float): This is the timeout (in seconds) to use when delivering webhooks for the call.. [optional]  # noqa: E501
            tag (str, none_type): Custom tag value. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, application_id, account_id, call_id, to, _from, call_url, answer_method, answer_url, disconnect_method, *args, **kwargs):  # noqa: E501
        """CreateCallResponse - a model defined in OpenAPI
