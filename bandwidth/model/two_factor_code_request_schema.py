...
class TwoFactorCodeRequestSchema(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, to, _from, application_id, message, digits, *args, **kwargs):  # noqa: E501
        """TwoFactorCodeRequestSchema - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, to, _from, application_id, message, digits, *args, **kwargs):  # noqa: E501
        """TwoFactorCodeRequestSchema - a model defined in OpenAPI
