...
class UpdateConferenceMember(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """UpdateConferenceMember - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            mute (bool): Whether or not this member is currently muted. Members who are muted are still able to hear other participants.  Updates this member's mute status. Has no effect if omitted.. [optional]  # noqa: E501
            hold (bool): Whether or not this member is currently on hold. Members who are on hold are not able to hear or speak in the conference.  Updates this member's hold status. Has no effect if omitted.. [optional]  # noqa: E501
