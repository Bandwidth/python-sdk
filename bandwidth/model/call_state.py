...
class CallState(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            call_id (str): [optional]  # noqa: E501
            ...
            direction (str): The direction of the call. Either `inbound` or `outbound`.. [optional]  # noqa: E501
            ...
            stir_shaken ({str: (str,)}, none_type): For inbound calls, the Bandwidth STIR/SHAKEN implementation will verify the information provided in the inbound invite request `Identity` header. The verification status is stored in the call state `stirShaken` property as follows.  | Property          | Description | |:------------------|:------------| | verstat | (optional) The verification status indicating whether the verification was successful or not. Possible values are `TN-Verification-Passed` or `TN-Verification-Failed`. | | attestationIndicator | (optional) The attestation level verified by Bandwidth. Possible values are `A` (full), `B` (partial) or `C` (gateway). | | originatingId | (optional) A unique origination identifier. |  More information: [Understanding STIR/SHAKEN](https://www.bandwidth.com/regulations/stir-shaken) . [optional]  # noqa: E501
            enqueued_time (datetime, none_type): If <a href='/docs/voice/rateLimits'>outbound call queueing</a> is enabled and this is an outbound call, the time this call was placed in queue.. [optional]  # noqa: E501
            ...
            disconnect_cause (str, none_type): Populated once the call has ended, with the reason the call ended. See above for possible values.. [optional]  # noqa: E501
